# Generated by Django 4.2.1 on 2023-06-15 13:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('category', models.CharField(choices=[('beach', 'beach'), ('museum', 'museum'), ('monumant', 'monumant')], max_length=30)),
                ...
                ('geoinfo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.geoinfo')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
